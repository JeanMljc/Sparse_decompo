function[X, P_est, W, Fmin] = IRL1_CPLEX_1ST(Y, A, C, W0, X0, P0, par_problem, par_cplex, K, p)
    
    % Solve 1ST order problem with non-convexe lp-norm
    %----------------------------------------------------------
    % INPUT 
    %
    ...
    for k=1:K-1
        [X{k+1}, P_est, Fmin(k), ~, ~] = Algo_CPLEX_1ST_QP(Y, A, ...
